      ...
      <>
        <Router>
          <div>
            ...
            <Routes>
              <Route path="/services/profile-toughened-glass-partition-work" element={<ProfileToughenedGlassPartitionWork/>}/>
              <Route path="/services/toughened-glass-partition-work" element={<ToughenedGlassPartitionWork/>}/>
              <Route path="/services/led-touch-sensor-mirror" element={<LEDTouchsensorMirror/>}/>
              <Route path="/services/upvc-windows-and-doors" element={<UPVCWindowsandDoors/>}/>
              <Route path="/services/ss-glass-railing-work" element={<SSGlassRailingWork/>}/>
              <Route path="/services/skylight-glass-paragola-work" element={<SkylightGlassParagolaWork/>}/>
              <Route path="/services/ms-gate-and-fabrication-work" element={<MSGateandFabricationWork/>}/>
              <Route path="/services/spider-glazing-work" element={<SpiderGlazingWork/>}/>
              <Route path="/services/shower-glass-partition-sliding" element={<ShowerGlassPartitionSlidingPartition/>}/>
              <Route path="/services/shower-glass-partition-openable" element={<ShowerGlassPartitionOpenable/>}/>
              <Route path="/services/walk-in-shower-glass-partition" element={<WalkInShowerGlassPartition/>}/>
            </Routes>
          </div>
          <Footer />
        </Router>
